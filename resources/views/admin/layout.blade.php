...
<html>
  <head>
    <meta charset="UTF-8">
    <title>{{ Config::get('app.name') }} :: {{ isset($pgTitle) ? $pgTitle : 'Intranet' }}</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="index2.html" class="logo">
          <span class="logo-mini"><b>{{ \Config::get('app.name-min', 'MB') }}</b></span>
              ...
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    ...
                    <p>
                      {{ Auth::user()->email }}
                      <small>Registrado em {{ date('m/Y', strtotime(Auth::user()->created_at)) }}</small>
                    </p>
                  </li>
                  <!-- Menu Body
                  <li class="user-body">
                  ...
                  <li class="user-footer">
                    <div class="pull-left">
                      <a href='/admin/user/{{ Auth::user()->id }}/edit' class="btn btn-default btn-flat">Perfil</a>
                    </div>
                    <div class="pull-right">
                      <a href='{{ action('Auth\AuthController@getLogout') }}' class="btn btn-danger btn-flat">Sair</a>
                    </div>
                  </li>
                </ul>
              </li>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="{{ action('Admin\BizController@index') }}"><i class="fa fa-circle-o"></i> Lojas</a></li>
                <li><a href="{{ action('Admin\UserController@index') }}"><i class="fa fa-circle-o"></i> Funcionários</a></li>
              </ul>
            </li>
            <?php } ?>
